...
```bash
# Encrypt a directory
gcrypt encrypt -c /path/to/gcrypt.config -s /path/to/source -e /path/to/encrypted
```
...
```bash
# Decrypt a directory
gcrypt decrypt -c /path/to/gcrypt.config -s /path/to/source -e /path/to/encrypted
```
